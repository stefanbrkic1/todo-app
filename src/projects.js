import { ModalHandler, ProjectsHandler, closeSidebarIfSmallScreen } from './dom';
...
export function addProjectToolsSubmitEvent() {
  ...
  renameProjectButton.addEventListener('click', () => {
    ...
    const existingProject = allProjectsLocal.find((project) => project.name === projectRenameInput.value);
