...
export function addTaskFormCreationEvent() {
  ...
  addTaskButtons.forEach((button, index) => {
    button.addEventListener('click', (e) => {
      ...
      const currentSectionTasksContainer = currentSectionHtmlElement.querySelector('.form-task-container');
      tasksHandler.createAddTaskFormHtml(currentSectionTasksContainer);
      addCancelButtonEvent(currentSectionTasksContainer);
      const currentAddTaskButtonContainer = currentSectionHtmlElement.querySelector('.add-task-container');
...
function addCancelButtonEvent(currentSectionTasksContainer) {
  ...
  cancelTaskFormButton.addEventListener('click', () => {
    const addTaskForm = currentSectionTasksContainer.querySelector('.add-task-form-container');
    if (addTaskForm) {
      addTaskForm.remove();
      addAddTaskButtons();
    }
